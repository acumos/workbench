  ...
  <div class="flex flex-col font-sans" id="project-catalog-webcomponent">
    ...
    <div class="flex">
      <div
        ...
        class="flex flex-col border p-4 m-4 shadow-xl justify-center w-64 justify-between cursor-pointer"
      >
      ...
      <div
        class="flex flex-col border p-4 m-4 shadow-xl justify-center w-64 justify-between "
      >
        <div class="flex flex-col">
          <div class="flex justify-center">
            <div
        ...
        <button class="btn btn-primary mb-2 mt-5">
          My Models
