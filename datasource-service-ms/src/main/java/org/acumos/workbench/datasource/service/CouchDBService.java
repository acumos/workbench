...
public class CouchDBService {
	 ...
	 */
	public DataSource updateDataSourceDetails(String authenticatedUserId, DataSource dataSource) {
	 ...
	 */
	public DataSource getDataSource(String dataSourceKey, String _id) {
	 ...
	 */
	public List<DataSource> getDataSourceForKey(String dataSourceKey) {
	 ...
	 */
	public void deleteDataSource(String _id, String _rev) {
	...
	public DataSourceAssociationModel insertDataSourceProjectAssociation(String authenticatedUserId, String projectId,
			String datasourceKey, DataSource dataSourceModel) {
	 ...
	 * @param projectId           The Project Id
	 * @return
	 * 		returns the list of DataSourceAssociationModel
	 */
	public List<DataSourceAssociationModel> getDataSourcesForProject(String authenticatedUserId, String projectId) {
	 ...
	 */
	public DataSourceAssociationModel fetchDataSourceProjectAssociationDetails(String associationId) {
	...
	public DataSourceAssociationModel updateDataSourceProjectAssociationDetails(
			DataSourceAssociationModel oldAssociation) {
	 ...
	 */
	public ServiceState deleteAssociationDetails(String associationId, String _rev) {
	 ...
	 */
	public DataSourceCollaboratorModel getDataSourceCollaborators(String dataSourceKey) {
	...
	public DataSourceCollaboratorModel removeCollaborator(String authenticatedUserId, String dataSourceKey,
			DataSourceCollaboratorModel oldDataSourceCollaboratorModel, Users collaborators) {
	 ...
	 */
	public List<DataSourceCollaboratorModel> sharedDataSources() {
		logger.debug("removeCollaborator() Begin");
		CouchDbClient dbClient = null;
	 ...
	 */
	public DataSourceAssociationModel getDataSourceAssociationDetails(String authenticatedUserId, String dataSourceKey, String dsVersion) {
	...
	private void associationExistsInCouch(String authenticatedUserId, String projectId, String datasourceKey,
			String dataSourceVersion, String associationStatus) {
