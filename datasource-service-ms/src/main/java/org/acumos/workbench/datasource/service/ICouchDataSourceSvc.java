...
public interface ICouchDataSourceSvc {
	
	/**
	 * Get the Couch Connection Status
	 * @param couchConnectionModel
	 * 			couch Connection model details
	 * @param dbQuery
	 * 			couch db query
	 * @return
	 * 			returns the couch db connection status
	 */
