...
import org.acumos.workbench.datasource.DataSourceServiceApplication;
...
public class SwaggerConfiguration {
	...
	public Docket swaggerSpringfoxDocket() {
		...
		docket = docket.select()
				.apis(RequestHandlerSelectors.basePackage("org.acumos.workbench.datasource.controller"))
