...
8. Remove user from the Collaborator List:
----------------------------------------
**Operation Name**
...
10. Remove user from collaborators list : Project service must call access couch db and get the related document details and remove the user from the collaborators list from couch db.After this successful execution,it must return Project object with updates collaborators with roles respectively otherwise it should return:

  a. serviceStatus.status.SERVICE_STATUS =ERROR
  b. serviceStatus.statusMessage = "Exception occured while finding the documents in couchDB"
  c. Send response to client with Http response code – 4xx NOT_FOUND

9. Get the list of shared Project for the logged in User:
---------------------------------------------------------
**Operation Name**
getSharedProjects
