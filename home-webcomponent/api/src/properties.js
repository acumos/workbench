...
var config = {
	local : {
		...
		datasetCatalogComponent: "http://localhost:9093",
		datasetComponent: "http://localhost:9094",
		portalFEURL: "http://localhost:8085",
		menuItems: '[{"title": "Dashboard", "icon": "fa fa-tachometer-alt", "link": "/pages/dashboard", "home": true}, {"title": "Projects", "icon": "fa fa-project-diagram", "link": "/pages/projects/catalog"}, {"title": "Notebooks", "icon": "fas fa-book-open", "link": "/pages/notebook/catalog"}, {"title": "Data Pipelines", "icon": "fa fa-code-branch", "link": "/pages/pipeline/catalog"},{"title": "Datasets", "icon": "fa fa-database", "link": "/pages/dataset/catalog"}, {"title": "AcuCompose", "icon": "fas fa-crop-alt", "link": "/pages/acuCompose"}]'
	},
	deploy : {
		...
		datasetCatalogComponent: process.env.datasetCatalogComponent,
		datasetComponent: process.env.datasetComponent,
