...
export class PipelineViewComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.loadComponent('pipelineComponent', 'pipeline-webcomponent-element', this.breadCrumbs);
  }
}
