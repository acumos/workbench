...
public class SwaggerConfiguration {
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo apiInfo = new ApiInfoBuilder()
				.title("ML Workbench Model Service REST API") 
	...
	/**
	 * Sets SecurityContext with JWT token (which need to be configured prior invoking any API) to be passed as header while invoking any API 
	 * @return
	 * 		SecurityContext with JWT token as Authorization header.
	 */
