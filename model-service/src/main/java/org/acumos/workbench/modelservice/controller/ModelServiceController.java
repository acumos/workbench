...
public class ModelServiceController {
	...
	@ApiOperation(value = "This API will list out all the Models that belongs to user")
	...
	@ApiOperation(value = "This API will list out all the Models that belongs to User under the Project")
	...
	@ApiOperation(value = "This API will Associate the Model to the Project")
	...
	@ApiOperation(value = "This API will Update the Model Association with Project")
	...
	@ApiOperation(value = "This API will Delete the Model Association with Project in ML Workbench")
