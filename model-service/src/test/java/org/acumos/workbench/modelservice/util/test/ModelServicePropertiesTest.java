...
public class ModelServicePropertiesTest {
	...
	public void getModelServicePropertiesTest(){
		modelServiceProperties.getCdsFindUserSolutionsExcp();
		modelServiceProperties.getCdsGetProjectModelsExcp();
		modelServiceProperties.getCdsGetSolutionException();
		modelServiceProperties.getCdsGetSolutionRevisionException();
		modelServiceProperties.getCdsGetUserExcp();
		modelServiceProperties.getMissingFieldValue();
	...
	public void associationStatusEnumTest(){
		...
		status.getAssociationStatusCode();
	}
