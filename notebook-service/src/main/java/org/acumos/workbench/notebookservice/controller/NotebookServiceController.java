...
public class NotebookServiceController {
	...
	NotebookValidationService notebookValidationService;
	 ...
	 * 		
	 */
	@ApiOperation(value = "Creates new  Notebook under a Project in ML Workbench")
	 ...
	 * 		returns the Notebook object with additional details. 
	 */
	@ApiOperation(value = "Creates new  independent Notebook for a User in ML Workbench")
	@RequestMapping(value = "/users/{authenticatedUserId}/notebooks", method = RequestMethod.POST)
    public ResponseEntity<?> createIndependentNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, @RequestBody Notebook notebook) {
	 ...
	 */
	@ApiOperation(value = "Launch the new instance of Notebook associated to a Project based on type and return the Notebook instance will URL.")
	@RequestMapping(value = "/users/{authenticatedUserId}/projects/{projectId}/notebooks/{notebookId}/launch", method = RequestMethod.GET)
	public ResponseEntity<?> launchProjectNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, @PathVariable("projectId") String projectId, @PathVariable("notebookId") String notebookId) {
	 ...
	 * 		returns Notebook instance
	 */
	@ApiOperation(value = "Launch the new instance of Notebook based on type and return the Notebook instance with URL.")
	@RequestMapping(value = "/users/{authenticatedUserId}/notebooks/{notebookId}/launch", method = RequestMethod.GET)
	public ResponseEntity<?> launchNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, @PathVariable("notebookId") String notebookId) {
		Notebook result = new Notebook();
	 ...
	 * 
	 */
	@ApiOperation(value = "Gets list of Notebook associated to a project")
	@RequestMapping(value = "/users/{authenticatedUserId}/projects/{projectId}/notebooks/", method = RequestMethod.GET)
    public ResponseEntity<?> getNotebooks(@PathVariable("authenticatedUserId") String authenticatedUserId, @PathVariable("projectId") String projectId) {
	 ...
	 * 
	 */
	@ApiOperation(value = "Gets list of all Notebook for a user")
	@RequestMapping(value = "/users/{authenticatedUserId}/notebooks/", method = RequestMethod.GET)
    public ResponseEntity<?> getAllNotebooks(@PathVariable("authenticatedUserId") String authenticatedUserId) {
	 ...
	 */
	@ApiOperation(value = "Updates existing Notebook associated to a Project")
	@RequestMapping(value = "/users/{authenticatedUserId}/projects/{projectId}/notebooks/{notebookId}", method = RequestMethod.PUT)
    public ResponseEntity<?> updatePrjectNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, 
	 ...
	 * 		returns Notebook object with addition and status details. 
	 */
	@ApiOperation(value = "Updates existing Notebook")
	@RequestMapping(value = "/users/{authenticatedUserId}/notebooks/{notebookId}", method = RequestMethod.PUT)
    public ResponseEntity<?> updateNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, 
    		@PathVariable("notebookId") String notebookId, 
    		@RequestBody Notebook notebook) {
		Notebook result = null;
	 ...
	 * 
	 */
	@ApiOperation(value = "Gets the existing Notebook details for a user")
	@RequestMapping(value = "/users/{authenticatedUserId}/notebooks/{notebookId}", method = RequestMethod.GET)
    public ResponseEntity<?> getNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, @PathVariable("notebookId") String notebookId) {
    ...
    public ResponseEntity<?> deleteNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, @PathVariable("notebookId") String notebookId) {
	 ...
	 */
	@ApiOperation(value = "Archive/Un Archive Notebook associated to a Project")
    ...
    public ResponseEntity<Notebook> archiveProjectNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, 
    		@PathVariable("projectId") String projectId,
    		@PathVariable("notebookId") String notebookId,
	 ...
	 * 		returns the Notebook Object with additional details indication project is been archived and status = 200.
	 */
	@ApiOperation(value = "Archive/Un Archive Notebook ")
	@RequestMapping(value = "/users/{authenticatedUserId}/notebooks/{notebookId}/{actionType}", method = RequestMethod.PUT)
    public ResponseEntity<Notebook> archiveNotebook(@PathVariable("authenticatedUserId") String authenticatedUserId, 
    		@PathVariable("notebookId") String notebookId,
    		@PathVariable("actionType") String actionType) {
		Notebook result = null;
	...
	private Notebook archiveNotebook(String authenticatedUserId,
		...
		result = notebookService.archiveProject(authenticatedUserId, projectId, notebookId, actionType );
		return result;
	}
}
