...
import org.acumos.workbench.notebookservice.vo.ArtifactState;
...
import org.acumos.workbench.notebookservice.vo.User;
...
public class NotebookServiceUtil {
	...
	public static MLPNotebook getMLPNotebook(String userId, Notebook notebook) {
		...
		if(null != notebook) { 
			...
			//TODO : Need to decided more on this, if required then UI should sent the appropriate value. 
