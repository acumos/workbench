...
public class ApplicationConfig {
	...
	public CommonDataServiceRestClientImpl commonDataServiceRestClientImpl() {
		CommonDataServiceRestClientImpl cdsClient = (CommonDataServiceRestClientImpl) CommonDataServiceRestClientImpl.getInstance(configProps.getCmndatasvcendpointurl(), configProps.getCmndatasvcuser(), configProps.getCmndatasvcpwd());
		return cdsClient;
	}
