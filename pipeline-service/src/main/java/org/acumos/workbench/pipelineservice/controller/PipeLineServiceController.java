...
public class PipeLineServiceController {
	...
	@ApiOperation(value = "Gets the list of all Pipelines for a User")
	...
	@ApiOperation(value = "Gets the existing Pipeline details for a User")
	 ...
	 */
	@ApiOperation(value = "Archive/UnArchive Pipeline")
