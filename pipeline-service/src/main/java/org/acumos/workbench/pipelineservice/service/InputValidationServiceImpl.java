...
public class InputValidationServiceImpl implements InputValidationService {
	...
	public void validatePipeLineInputJsonStructure(Pipeline pipeLine) throws InvalidInputJsonStructureException {
		...
		if (!result) {
			logger.warn("Incorrectly formatted input – Invalid JSON");
	...
	public void isValueExists(String fieldName, String value) throws ValueNotFoundException {
		...
		if (!result) {
			logger.warn("Mandatory field : " + fieldName + " is missing");
	...
	public void validatePipeLineName(String value) throws IncorrectValueException {
		...
		if (!result) {
			logger.warn("Pipeline Name Syntax Invalid");
	...
	public void validateVersion(String value) throws IncorrectValueException {
		...
		if (!result) {
			logger.warn("Pipeline Version Syntax Invalid in validateVersion() method");
			throw new IncorrectValueException(msg);
		}
