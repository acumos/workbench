...
public interface PipeLineService {
	 ...
	 */
	public void pipeLineExists(String authenticatedUserId, String projectId, Pipeline pipeLine) throws DuplicatePipeLineException;

	/**
	 * This method is to check if the Project exists in the DB using CDS Client.
	 * @param authenticatedUserId
	 * 		the authenticated user Id
	 * @param projectId
	 * 		the projectId
