...
module.exports = function(app) {
	...
	app.post('/api/pipeline/details', function (req, res){
		...
		getSelectedPipelineDetails(userName, serviceUrl, pipelineId, getLatestAuthToken(req, authToken)).then(function(result){
			res.send(result);
		});
	});
	...
	var getSelectedPipelineDetails = function(userName, srvcUrl, pipelineId, authToken){
