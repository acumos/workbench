...
public class PredictorServiceConstants {
	...
	public static final String GETPREDICTORSQUERY = "{\"selector\":{\"$and\":[{\"predcitorId\":{\"$eq\":\"%s\"}},{\"associationStatus\":{\"$eq\":\"%s\"}}]}}";
	...
	public static final String PREDICTOREXISTSINCOUCHQUERY = "{\"selector\":{\"$and\":[{\"predcitorId\":{\"$eq\":\"%s\"}},{\"predictorDeploymentStatus\":{\"$eq\":\"%s\"}}]}}";
