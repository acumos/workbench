...
public class ApplicationConfiguration {
	...
	public CommonDataServiceRestClientImpl commonDataServiceRestClientImpl() {
		CommonDataServiceRestClientImpl cdsClient = (CommonDataServiceRestClientImpl) CommonDataServiceRestClientImpl
				.getInstance(confProps.getCmndatasvcurl(), confProps.getCmndatasvcuser(), confProps.getCmndatasvcpwd());
		return cdsClient;
	}
	...
	public ProjectServiceRestClientImpl projectServiceRestClientImpl() {
		ProjectServiceRestClientImpl projectRestClient = new ProjectServiceRestClientImpl(
				confProps.getProjectServiceURL());
		return projectRestClient;
	}
	
	@Bean
	@Lazy(value = true) 
	public ModelServiceRestClientImpl modelServiceRestClientImpl() {
		ModelServiceRestClientImpl modelRestClient = new ModelServiceRestClientImpl(confProps.getModelServiceURL());
		return modelRestClient;
	}
