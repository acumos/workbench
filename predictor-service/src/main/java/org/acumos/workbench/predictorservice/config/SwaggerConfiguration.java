...
package org.acumos.workbench.predictorservice.config;

import java.util.Date;
import java.util.List;

import org.acumos.workbench.common.security.SecurityConstants;
import org.acumos.workbench.predictorservice.PredictorServiceApplication;
...
public class SwaggerConfiguration {
	...
	public Docket swaggerSpringfoxDocket() {
		...
		docket = docket.select()
				.apis(RequestHandlerSelectors.basePackage("org.acumos.workbench.predictorservice.controller"))
				.paths(PathSelectors.any()).build();
		return docket;
	}

	private ApiInfo apiInfo() {
		final String version = PredictorServiceApplication.class.getPackage().getImplementationVersion();
		ApiInfo apiInfo = new ApiInfoBuilder().title("ML Workbench Predictor Service REST API")
				.description("Methods supporting all Predictor Service APIs")
