...
public class PredictorManagerController {
	...
	@RequestMapping(value = "/users/{authenticatedUserId}/{projectId}/predictorList", method = RequestMethod.GET)
...
//	@ApiOperation(value = "Get Predictor Details for Predictor ID and also validate the status of k8s deployment")
//	@RequestMapping(value = "/users/{authenticatedUserId}/{predictorId}/{projectId}/", method = RequestMethod.GET)
//	public ResponseEntity<?> getPredictorDeployValidation(HttpServletRequest request,
//			@ApiParam(value = "Acumos User login Id", required = true) @PathVariable("authenticatedUserId") String authenticatedUserId,
//			@ApiParam(value = "PredictorId", required = true) @PathVariable("predictorId") String predictorId,
...
//		
//		Predictor result=predictorServiceImpl.getPredictorByUserProject(authenticatedUserId,projectId);
//
