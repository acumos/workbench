...
import org.acumos.workbench.predictorservice.exception.InputValidationException;
...
public class PredictorManagerController {
	...
	public ResponseEntity<?> createPredictor(HttpServletRequest request,
		...
		if (null != kvPairList && !kvPairList.isEmpty()) {
			...
			logger.error("Mandatory field kvPairList is null or empty");
			throw new InputValidationException("Mandatory field kvPairList is null or empty");
		}
