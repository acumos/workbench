...
public class ModelServiceRestClientImpl implements ModelServiceRestClient{
	...
	private static final String MODEL_SERVICE_GET_MODEL_EXCP = "Model Service - Get Model";
	...
	public ModelServiceRestClientImpl(String projServiceURL) { 
	...
	public ResponseEntity<List<Model>> getModels(String authenticatedUserId, String projectId, String authToken) {
		...
		try { 
			...
			response = restTemplate.exchange(uri, HttpMethod.GET, entity, new ParameterizedTypeReference<List<Model>>(){});
		} catch (Exception e) { 
