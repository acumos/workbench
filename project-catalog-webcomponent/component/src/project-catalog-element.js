...
export class ProjectCatalogLitElement extends DataMixin(ValidationMixin(BaseElementMixin(LitElement))) {
  ...
  createProject(){
    ...
    this.resetMessage();
      ...
      console.info('Request failed', error);
      this.errorMessge = 'Project create request failed with error: '+ error;
    });
  }
      ...
      ${this.view === 'view'
        ? html`
            <div class="row" style="margin:5px 0">
              <div class="col-lg-12">
                <div class="row" style="margin:15px 0; margin-bottom:30px;">
                  <p class="error-status"> ${this.errorMessge}</p>
                  <p class="success-status"> ${this.successMessge}</p>
                  <div
