...
export class ProjectCatalogLitElement extends DataMixin(ValidationMixin(LitElement)) {
  ...
  createProject(){
	  var payload = {  
        	  "projectId" : {    
        		  ...
        		  "versionId" : {      
        			  "comment" : "",      
        			  "label" : this.data.newProject.version    
        				  }  
          },  
          "description" : this.data.newProject.description
          };
  ...
  getProjects() {
    ...
    this.activeSort = "projectId.name";
                      ...
                      html`
                        <div class="col-md-3">
                          ...
                          >
                            <a
                              href="javascript:void"
                              @click=${e => this.userAction("view-project", item.projectId.uuid)}
                            >
                              <div class="card-body">
                                <h4 class="project-name">${item.projectId.name}</h4>
                                <span><strong>Project ID</strong>: &nbsp; ${item.projectId.uuid}</span
                                ><br />
                                <span
                                  ><strong>Project Version</strong>: &nbsp;
                                  ${item.projectId.versionId.label}</span
                                ><br />
                                <strong>Project Status</strong>: &nbsp;
                                ${item.artifactStatus.status === "active"
                                  ? html`
                                      <span class="active-status">${item.artifactStatus.status}</span>
                                    `
                                  : html`
                                      <span class="inactive-status">${item.artifactStatus.status}</span>
                                    `}
                                <br />
                                <span
                                  ><strong>Creation Date</strong>: &nbsp; ${item.projectId.versionId.timeStamp}</span
                                ><br />
                                <span
                                  ><strong>Modified Date</strong>: &nbsp; ${item.projectId.versionId.timeStamp}</span
                                ><br />
                                <br />
                                ...
                                <div class="gray-light pt-2 pb-2 pl-2 pr-2">
                                  ...
                                  >
                                    <div style="margin-top:8px;">
                                      <span title="${item.projectId.uuid}"
                                    ...
                                    <div>
                                      ${item.artifactStatus.status === "active"
                                        ? html`
                                            <a
                                              href="javascript:void"
                                              @click=${e => this.archiveProject(item.projectId.uuid)}
                                        ...
                                        : html`
                                            <a
                                              href="javascript:void"
                                              @click=${e => this.restoreProject(item.projectId.uuid)}
                                              class="btnIcon btn btn-sm my-1 mr-1"
                                              data-toggle="tooltip"
                                              data-placement="top"
                                            ...
                                            <a
                                              href="javascript:void"
                                              @click=${e => this.deleteProject(item.projectId.uuid)}
                                              class="btnIcon btn btn-sm my-1 mr-1"
                                              data-toggle="tooltip"
                                              data-placement="top"
