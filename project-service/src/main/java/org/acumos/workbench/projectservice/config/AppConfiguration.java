...
public class AppConfiguration {
	...
	public CommonDataServiceRestClientImpl commonDataServiceRestClientImpl() {
		CommonDataServiceRestClientImpl cdsClient = (CommonDataServiceRestClientImpl) CommonDataServiceRestClientImpl.getInstance(confProps.getCmndatasvcendpoinurl(), confProps.getCmndatasvcuser(), confProps.getCmndatasvcpwd());
		return cdsClient;
	}
