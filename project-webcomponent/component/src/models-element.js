				...
				<div class="row">
					<div class="col">
						<div class="form-group">
							...
							${(this.data.linkModel.modelId.metrics.kv[2].value !== undefined && this.data.linkModel.modelId.metrics.kv[2].value !== "null" && this.data.linkModel.modelId.metrics.kv[2].value !== '')
							? html`
