...
class ProjectModelsLitElement extends DataMixin(ValidationMixin(BaseElementMixin(LitElement))) {
    ...
    this.data = {
		...
		this.$data.set('linkModel.modelCatalog', '');
		this.$data.set('linkModel.modelType', '');
    ...
    this.$data.set('linkModel.modelId.versionId.label', selectedModel[0].version);
		...
		this.$data.set('linkModel.modelType', selectedModel[0].modelType);
	}
					...
					<div class="col">
						<div class="form-group">
							...
							<select class="form-control" id="mySelectCatalog" @change="${e => {
								...
								this.$data.set('linkModel.modelCatalog', e.target.value);
								this.$validations.validate('linkModel.modelCatalog');
								}}">
							...
							${
								this.$validations.getValidationErrors('linkModel.modelCatalog').map(error => {
									switch (error) {
										case 'isNotEmpty':
				...
				<div class="row">
					<div class="col">
						<div class="form-group">
							...
							${(this.data.linkModel.modelCatalog !== undefined && this.data.linkModel.modelCatalog !== "null" && this.data.linkModel.modelCatalog !== '')
							? html`
								<select class="form-control" id="mySelect" @change="${e => {
									this.filterModelsToSelect(e.target.value);
									this.$data.set('linkModel.modelType', e.target.value);
									this.$validations.validate('linkModel.modelType');
									}}">
								...
								${
									this.$validations.getValidationErrors('linkModel.modelType').map(error => {
										switch (error) {
											case 'isNotEmpty':
				...
				<div class="row">
					<div class="col">
						<div class="form-group">
							...
							${(this.data.linkModel.modelType !== undefined && this.data.linkModel.modelType !== "null" && this.data.linkModel.modelType !== '')
							? html`
