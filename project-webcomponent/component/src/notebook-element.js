...
class ProjectNotebookLitElement extends DataMixin(ValidationMixin(BaseElementMixin(LitElement))) {
    ...
    this.$data.set('associateErrorMessage', '');
		...
		this.$data.set('newNotebook.noteBookId.uuid', '');
 ...
 sortNotebooks(key) {
  ...
  getFilteredCount(criteria) {
	...
	linkNotebook(notebook){
		...
		this.noteBookId = notebook[0].noteBookId;
  ...
  openModalEdit(item) {
	  ...
	  this.$data.set('editNotebook.noteBookId.name', item.name);
		this.$data.set('editNotebook.noteBookId.versionId.label', item.version);
		this.$data.set('editNotebook.noteBookId.uuid', item.noteBookId);
	  this.$data.set('editNotebook.description', item.description);
	  this.$data.set('editNotebook.notebookType', item.notebookType);
  ...
  render() {
    return html`
      ...
      <omni-modal title="Associate Notebook" close-string="Associate Notebook" dismiss-string="Cancel"
	    ...
	    <omni-modal title="Edit Notebook" close-string="Edit Notebook" dismiss-string="Cancel"
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter Notebook Name" value="${this.data.editNotebook.noteBookId.name}"
                  @blur="${ e => {
                    this.$data.set('editNotebook.noteBookId.name', e.target.value);
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter Notebook Version" value="${this.data.editNotebook.noteBookId.versionId.label}"
                  @blur="${ e => {
                      this.$data.set('editNotebook.noteBookId.versionId.label', e.target.value);
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                <label>Notebook Description</label>
                <textarea class="form-control" placeholder="Enter Notebook Description"
                  @blur="${e => this.$data.set('editNotebook.description', e.target.value)}">${this.data.editNotebook.description}</textarea>
              </div>
            </div>
          </div>
        </form>
