								...
								<div class="btn-toolbar mb-2 mb-md-0">
									...
									<div class="btn-group mr-2">
										...
										<div class="input-group-append">
											...
											<a href="javascript:void" @click=${(e) => this.userAction('view-project', item.id)} class="btnIcon btn btn-sm btn-secondary  mr-1" data-toggle="tooltip" data-placement="top" title="Associate Existing Pipeline">
							...
							<div class="row" style="margin:40px 0; margin-bottom: 10px;">
								<table class="table table-bordered table-sm" id="cssTable">
									<thead class="thead-light">
										<tr class="d-flex">
											<th class="col-1" >#</th>
											<th class="col-5" >Data Pipeline Name</th>
										...
										${this.displayPipelineLists.map((item, index) => 
											...
											<tr class="d-flex">
												...
												<td class="col-2" style="padding: .05rem; padding-left: 20px;">
													...
													<a href="javascript:void" @click=${(e) => this.userAction('view-project', item.id)} class="btnIcon btn btn-sm btn-secondary my-1 mr-1" data-toggle="tooltip" data-placement="top" title="Delete Pipeline Instance">
					...
					<div class="card mb-124  shadow mb-5 bg-white rounded">
						...
						<div class="card-body">
							<div class="row" style="margin:10px 0;margin-bottom:20px;">
								<h7 >No Data Pipelines.</h7>
							</div>
							<div class="row" style="margin:10px 0">
								<button type="button" class="btn btn-primary" @click=${this.submitProject}>Create Pipeline</button>&nbsp;&nbsp;&nbsp;
								<button type="button" class="btn btn-secondary-button" @click=${this.submitProject}>Associate Existing Pipeline</button>
							</div>
						</div>
					</div>
				</div>
