                ...
                ${
                  this.$validations.getValidationErrors('newPipeline.pipelineId.name').map(error => {
                    switch (error) {
                      ...
                      case 'pattern':
                        return html`<div class="invalid-feedback d-block">Data Pipeline Name is not valid. </div>`
                    }
                  })
                }
              </div>
                ...
                ${
                  this.$validations.getValidationErrors('newPipeline.pipelineId.versionId.label').map(error => {
                    switch (error) {
                      ...
                      case 'pattern':
                        return html`<div class="invalid-feedback d-block">Data Pipeline version is not valid. </div>`
                    }
                  })
                }
              </div>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Enter Data Pipeline Description"
      ...
      <omni-modal title="Associate Data Pipeline" close-string="Associate Data Pipeline" dismiss-string="Cancel"
        ...
        <form novalidate>
          <p class="text-danger">${this.data.createErrorMessage} </p>
			...
			<omni-modal title="Edit Data Pipeline" close-string="Edit Data Pipeline" dismiss-string="Cancel"
