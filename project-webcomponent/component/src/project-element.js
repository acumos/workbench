  ...
  static get properties() {
    ...
    render() {
      return html`         
        ...
        <omni-dialog title="Archive ${this.data.project.projectName}" close-string="Archive Project" dismiss-string="Cancel"
          ...
          <form><P>Are you sure want to archive ${this.data.project.projectName}?</p></form>
        </omni-dialog>
  
        <omni-dialog title="Unarchive ${this.data.project.projectName}" close-string="Unarchive Project" dismiss-string="Cancel"
          ...
          <form><P>Are you sure want to unarchive ${this.data.project.projectName}?</p></form>
        </omni-dialog>
  
        <omni-dialog title="Delete ${this.data.project.projectName}" close-string="Delete Project" dismiss-string="Cancel"
          ...
          <form><P>Are you sure want to delete ${this.data.project.projectName}?</p></form>
        </omni-dialog>
              ...
              <div class="card mb-124  shadow mb-5 bg-white">
                <div class="card-header">
                  <div class="row" style="margin:5px 0; margin-top: 0px;">
                    ...
                    <h4 class="textColor card-title">${this.data.project.projectName}</h4>&nbsp;&nbsp;&nbsp;&nbsp;
                    ${this.data.project.projectStatus === 'ACTIVE'
                      ? html`
                        ${this.isEdit 
                          ? html`
