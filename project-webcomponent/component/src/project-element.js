        ...
        ${this.view === 'view'
                ...
                <div style="position: absolute; right:0" >
                  <div class="input-group-append">
                    ...
                    ? html`
                      ...
                      <a href=${this.projectWikiURL} target="_blank" class="btnIcon btn btn-sm btn-secondary mr-1"
          ...
          ${this.data.project.projectStatus === "ACTIVE"
        	? html`
        	   ...
        	   <project-pipeline-element componenturl=${this.componenturl} projectId=${this.projectId}></project-pipeline-element>
        	`
        	:``
          }
