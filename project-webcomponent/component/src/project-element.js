  ...
  static get properties() {
    ...
    constructor() {
      ...
      this.$validations.init({
        validations: {
          project: {
            projectName: { isNotEmpty: Forms.validators.isNotEmpty },
            projectDesc: { isNotEmpty: Forms.validators.isNotEmpty },
            projectVersion: { isNotEmpty: Forms.validators.isNotEmpty },
            projectStatus: { isNotEmpty: Forms.validators.isNotEmpty },
          }
        }
      })
