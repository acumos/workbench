				...
				<div class="col-md-12 py-3">
					<div class="card mb-124 shadow mb-5 bg-white rounded">
						<div class="card-body ">
							...
							<div class="row" style="margin:20px 0; position: absolute; right:0">
							...
							<div class="row" style="margin:30px 0; margin-bottom: 10px;">
								<table class="table table-bordered table-sm" id="cssTable">
									<thead class="thead-light">
										<tr class="d-flex">
											<th class="col-1" >#</th>
											<th class="col-7" >Notebook Name</th>
										...
										${this.displayNotebookLists.map((item, index) => 
											...
											<tr class="d-flex">
												...
												<td class="col-2" style="padding: .05rem;">
													<a href="javascript:void" @click=${(e) => this.userAction('view-project', item.id)}   class="btnIcon btn btn-sm btn-primary my-1 mr-1" data-toggle="tooltip" data-placement="top" title="View Notebook Instance">
															<mwc-icon>remove_red_eye</mwc-icon>
													</a>&nbsp;&nbsp;
													<a href="javascript:void" @click=${(e) => this.userAction('view-project', item.id)} class="btnIcon btn btn-sm btn-primary my-1 mr-1 " data-toggle="tooltip" data-placement="top" title="Edit Notebook Instance">
															<mwc-icon>edit</mwc-icon>
													</a>&nbsp;&nbsp;
													<a href="javascript:void" @click=${(e) => this.userAction('view-project', item.id)} class="btnIcon btn btn-sm btn-primary my-1 mr-1" data-toggle="tooltip" data-placement="top" title="Delete Notebook Instance">
							...
							<div class="row" >
								<h7 >&nbsp;&nbsp;&nbsp;&nbsp;Showing ${this.startIndex} to ${this.endIndex} of ${this.totalRecords} Notebooks</h7>
								<div style="position: absolute; right:0" >
				...
				<div class="col-md-12 py-3">
					<div class="card mb-124  shadow mb-5 bg-white rounded">
						<div class="card-body">
							...
							<hr>
							<div class="row" style="margin:10px 0">
								<h7 >You currently have no Notebooks.</h7>
