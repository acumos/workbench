<template>
  <ValidationObserver ref="form" tag="div" class="flex flex-col w-full">
    <ToastUI id="notebook-form" class="relative p-2" innerClass="w-full"></ToastUI>
    <div class="p-3">
      <div class="flex mb-2">
        <div class="flex-1 flex flex-col">
          ...
          >
            <select class="form-select" v-model="updatedNotebook.type" :disabled="!isNew">
      ...
      <div class="flex mb-2">
        ...
        <div class="flex-1 flex flex-col">
          ...
          <input class="form-input" type="text" v-model="updatedNotebook.version" />
        </div>
      </div>
    ...
    <div class="flex justify-between py-3 px-2 bg-gray-100 border-gray-200 border-t">
      ...
      >{{ isNew ? "Create" : "Save" }} Notebook</button>
    </div>
  </ValidationObserver>
</template>
