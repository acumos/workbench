<template>
  <div class="flex w-full" v-if="project">
    ...
    >
      <CollaboratorsList :initialCollaborators="collaborators" @onClose="isManagingCollaborators = false"/>
    </modal-ui>
  </div>
</template>
...
export default {
  ...
  watch: {
    project(currentProject) {
      ...
      if(this.updatedProject.collaborators !== [] && this.updatedProject.collaborators !== null)
        this.collaborators = this.updatedProject.collaborators.users.map(user => Collaborator.$fromJson(user));
